...
export class ProductoListComponent implements OnInit {
  ...
  ListarProductos() {
    ...
    if ( this.llamadoDesde == 'promociones' ) {
      this.filtro = 'promociones';  
      // console.log( 'filtro promociones') ;

    } else {
        if ( this.llamadoDesde == 'personales' ) {
          this.filtro = 'personales';  
    
        } else {
            if ( this.llamadoDesde == 'empresas' ) {
              ...
              if ( this.llamadoDesde == 'kits' ) {
                ...
                if ( this.llamadoDesde == 'kitsInicio' ) {
                  this.filtro = 'kits';     // al final no lo uso, hice otro otro componente
