...
export class CategoriaPage implements OnInit {
  ...
  loading: any;
  categoria = new RespuestaCategorias();
  ...
  ngOnInit() {
    ...
    if ( id !== 'nuevo' ) {
        this.categoriasServ.getCategoria( id )
          .subscribe( (resp: RespuestaCategorias)  => {
            this.categoria = resp;
  ...
  guardar( formulario: NgForm ) {
    ...
    if ( this.categoria.idCategoria ) {
      ...
      peticion = this.categoriasServ.actualizarCategoria( this.categoria );
      mensajeUser = 'OK! Se actualizaron los datos';
    } else {
      // No existe, agrego un documento
      peticion = this.categoriasServ.crearCategoria( this.categoria );
