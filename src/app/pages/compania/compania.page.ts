...
export class CompaniaPage implements OnInit {
  ...
  loading: any;
  compania = new RespuestaCompanias();
  ...
  ngOnInit() {
    ...
    if ( id !== 'nuevo' ) {
      ...
      this.apiEntidad = 'compania';

      this.apiconnectService.getRegistro( id, this.apiEntidad )
          .subscribe( (resp: RespuestaCompanias)  => {
            this.compania = resp;
            this.compania.idCompania = id;
            // console.log('marca:', this.compania.marcaCotProd)
  ...
  guardar( formulario: NgForm ) {
    ...
    if ( this.compania.idCompania ) {

      // Existe y lo actualizo
      this.apiEntidad = 'companias';
      peticion = this.apiconnectService.actualizarRegistro( this.compania, this.apiEntidad, this.compania.idCompania );
      ...
      this.apiEntidad = 'companias';
      peticion = this.apiconnectService.crearRegistro( this.compania, this.apiEntidad );
    ...
    peticion.subscribe ( resp => {
      ...
      // Redirigo a la lista
      this.router.navigateByUrl('/companias/todos');
      // this.router.navigateByUrl(`/companias/${ this.compania.idCompania }`);
