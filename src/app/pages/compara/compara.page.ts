...
@Component({
  ...
  templateUrl: './compara.page.html',
  styleUrls: ['./compara.page.scss'],
})
export class ComparaPage implements OnInit {


  loading: any;
  compara = new RespuestaComparas();
  ...
  ngOnInit() {
    ...
    if ( id !== 'nuevo' ) {
      ...
      this.apiEntidad = 'compara';

      this.apiconnectService.getRegistro( id, this.apiEntidad )
          .subscribe( (resp: RespuestaComparas)  => {
            this.compara = resp;
            this.compara.idCompara = id;
            // console.log('marca:', this.compara.marcaCotProd)
  ...
  guardar( formulario: NgForm ) {
    ...
    if ( this.compara.idCompara ) {

      // Existe y lo actualizo
      this.apiEntidad = 'comparas';
      peticion = this.apiconnectService.actualizarRegistro( this.compara, this.apiEntidad, this.compara.idCompara );
      ...
      this.apiEntidad = 'comparas';
      peticion = this.apiconnectService.crearRegistro( this.compara, this.apiEntidad );
    ...
    peticion.subscribe ( resp => {
      ...
      // Redirigo a la lista
      this.router.navigateByUrl('/comparas');
