...
export class ConfiguracionPage implements OnInit {
  ...
  loading: any;
  configuracion = new RespuestaConfiguraciones();
  ...
  ngOnInit() {
    ...
    if ( id !== 'nuevo' ) {
      ...
      this.apiEntidad = 'configuracion';

      this.apiconnectService.getRegistro( id, this.apiEntidad )
          .subscribe( (resp: RespuestaConfiguraciones)  => {
            this.configuracion = resp;
            this.configuracion.idConfiguracion = id;
            // console.log('marca:', this.configuracion.marcaCotProd)
  ...
  guardar( formulario: NgForm ) {
    ...
    if ( this.configuracion.idConfiguracion ) {

      // Existe y lo actualizo
      this.apiEntidad = 'configuraciones';
      peticion = this.apiconnectService.actualizarRegistro( this.configuracion, this.apiEntidad, this.configuracion.idConfiguracion );
      ...
      this.apiEntidad = 'configuraciones';
      peticion = this.apiconnectService.crearRegistro( this.configuracion, this.apiEntidad );
  ...
  async configuracionMore( evento ) {
