...
export class PersonalizacionPage implements OnInit {
  ...
  loading: any;
  personalizacion = new RespuestaPersonalizaciones();
  ...
  ngOnInit() {
    ...
    if ( id !== 'nuevo' ) {
      ...
      this.apiEntidad = 'personalizacion';

      this.apiconnectService.getRegistro( id, this.apiEntidad )
          .subscribe( (resp: RespuestaPersonalizaciones)  => {
            this.personalizacion = resp;
            this.personalizacion.idPersonalizacion = id;
            // console.log('marca:', this.personalizacion.marcaCotProd)
  ...
  guardar( formulario: NgForm ) {
    ...
    if ( this.personalizacion.idPersonalizacion ) {

      // Existe y lo actualizo
      this.apiEntidad = 'personalizaciones';
      peticion = this.apiconnectService.actualizarRegistro( this.personalizacion, this.apiEntidad, this.personalizacion.idPersonalizacion );
      ...
      this.apiEntidad = 'personalizaciones';
      peticion = this.apiconnectService.crearRegistro( this.personalizacion, this.apiEntidad );
    ...
    peticion.subscribe ( resp => {
      ...
      // Redirigo a la lista
      // this.router.navigateByUrl('/personalizaciones');
      this.router.navigateByUrl(`/personalizaciones/${ this.personalizacion.idProdPersonalizacion }`);
  ...
  async personalizacionMore( evento ) {
