...
@Component({
  ...
  styleUrls: ['./reparacion.page.scss'],
})
export class ReparacionPage implements OnInit {

  loading: any;
  reparacion = new RespuestaReparaciones();
  ...
  ngOnInit() {
    ...
    if ( id !== 'nuevo' ) {
      ...
      this.apiEntidad = 'reparacion';

      this.apiconnectService.getRegistro( id, this.apiEntidad )
          .subscribe( (resp: RespuestaReparaciones)  => {
            this.reparacion = resp;
            this.reparacion.idReparacion = id;
            // console.log('marca:', this.reparacion.marcaCotProd)
  ...
  guardar( formulario: NgForm ) {
    ...
    if ( this.reparacion.idReparacion ) {

      // Existe y lo actualizo
      this.apiEntidad = 'reparaciones';
      peticion = this.apiconnectService.actualizarRegistro( this.reparacion, this.apiEntidad, this.reparacion.idReparacion );
      ...
      this.apiEntidad = 'reparaciones';
      peticion = this.apiconnectService.crearRegistro( this.reparacion, this.apiEntidad );
